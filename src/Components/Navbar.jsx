      ...
      <div className="container mx-auto flex items-center justify-between p-4 h-24">
        ...
        <div className="text-xl font-bold">
          <Link to="/" onClick={handleScrollToTop} className="flex items-center">
            <img src={logo} alt="Logo" className="w-64 h-64 lg:w-64 lg:h-64 mr-2 mt-3"/>
          </Link>
        </div>
        ...
        <div className="hidden md:flex md:items-center md:space-x-4 text-lg">
          <Link
            to="/"
            className="py-2 px-4 hover:bg-[#21029E] hover:text-white rounded font-semibold"
        ...
        <div className="space-x-4 hidden lg:flex">
          <button className="bg-[#21029E] text-white py-2 px-4 rounded-lg hover:bg-blue-900 transition-colors">
            <a href="tel:9312369690" className="hover:text-white">Contact us</a>
          </button>
          <button className="bg-[#21029E] text-white py-2 px-4 rounded-lg transition-colors hover:bg-blue-900">
            <a href="mailto:sidharthchemhouse@gamil.com" className="hover:text-white">Send Mail</a>
          </button>
        </div>
      </div>
    </nav>
